...
{
    public partial class frmGenelYonetimGiderRaporu : Form
    {
        ...
        public frmGenelYonetimGiderRaporu()
        {
            InitializeComponent();
            #region yetkiler
        ...
        private void frmGenelYonetimGiderRaporu_Load(object sender, EventArgs e)
        {
            kasatumulistele();
