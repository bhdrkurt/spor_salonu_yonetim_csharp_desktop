...
{
    public partial class frmGenelYonetimGiderEkle : Form
    {
        public static GirisBilgi User { get; set; }
        public frmGenelYonetimGiderEkle()
        {
            InitializeComponent();
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            {
                    con.Open();
                    SqlCommand komut = new SqlCommand("INSERT INTO GenelYonetimGideri(aciklama) VALUES (@p1)", con);
                    komut.Parameters.AddWithValue("@p1", txtAciklama.Text);
                    komut.ExecuteNonQuery();
                    con.Close();
                    label4.Visible = true;
                    label4.ForeColor = Color.Green;
                    label4.Text = "Kayıt Yapıldı";
            }
            else
            {
                con.Close();
                label4.Visible = true;
                label4.Text = "kayıt yapalamadı.";
            }
