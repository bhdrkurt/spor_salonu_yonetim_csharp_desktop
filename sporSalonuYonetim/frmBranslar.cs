    ...
    public partial class frmBranslar : Form
    {
        ...
        private void btnBransKaydet_Click(object sender, EventArgs e)
        {
            ...
            if (txtBransAdi.Text == "")
            {
                ...
                label2.Text = "Lütfen Branş Adını giriniz.";

            }


            else if (txtBransAdi.Text != "")
            {

                con.Open();
                SqlCommand komut = new SqlCommand("INSERT INTO Branslar(bransAdi) VALUES (@p1)", con);
            ...
            else
            {
                ...
                label3.Text = "Yazı Rengi Kırmızı Olan Yere Dikkat Ediniz.";
            }
        }
