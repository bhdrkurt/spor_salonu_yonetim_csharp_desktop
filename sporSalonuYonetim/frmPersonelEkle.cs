...
namespace sporSalonuYonetim
{
    public partial class frmPersonelEkle : Form
    {
        ...
        private void bransgetir()
        {
            ...
            cmd.CommandText = "SELECT Branslar.bransAdi FROM Branslar ORDER BY Branslar.bransAdi ASC";
            cmd.ExecuteNonQuery();
            ...
            {
                cmbBransSec.Items.Add(dr["bransAdi"].ToString());
            }
            con.Close();
        }
        private void btnPersonelKaydet_Click(object sender, EventArgs e)
        {
            ...
            if (txtPersonelAdSoyad.Text == "")
            {
                ...
                label2.Text = "Lütfen Personel Adını ve Soyadını giriniz.";

            }


            else if (cmbBransSec.Text == "")
            {

                label2.ForeColor = Color.Red;
                label2.Text = "Lütfen Branş Seçiniz.";
            }
            else if (txtPersonelAdSoyad.Text != "" && cmbBransSec.Text != "")
            {

                con.Open();
                SqlCommand komut = new SqlCommand("INSERT INTO PersonelKayit(personelAdi,personelBransi) VALUES (@p1,@p2)", con);
                komut.Parameters.AddWithValue("@p1", txtPersonelAdSoyad.Text);
                komut.Parameters.AddWithValue("@p2", cmbBransSec.Text);

                komut.ExecuteNonQuery();
                con.Close();
                label4.ForeColor = Color.Green;
                label4.Text = "Kayıt Tamamlanmıştır.";
            ...
            else
            {
                ...
                label4.Text = "Kayıt Yapılamadı";
                label2.ForeColor = Color.Orange;
                label2.Text = "Yazı Rengi Kırmızı Olan Yere Dikkat Ediniz.";
            }
        }
