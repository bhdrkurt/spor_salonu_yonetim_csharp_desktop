...
{
    public partial class frmToptanciRaporu : Form
    {
        public static GirisBilgi User { get; set; }
        public frmToptanciRaporu()
        {
            InitializeComponent();
        ...
        void isimgetir()
        {
            ...
            cmd.CommandText = "SELECT ToptanciAlisverisRapor.raporToptanciAdi FROM ToptanciAlisverisRapor";
            cmd.ExecuteNonQuery();
        ...
        void raporlistele()
        {
            SqlConnection con = new SqlConnection(gnl.conString);
            con.Open();
            da = new SqlDataAdapter("SELECT raporKayitTarihi,raporToptanciAdi,raporUrunAdi,raporAlisFiyati,raporAdet,raporToplamFiyat FROM ToptanciAlisverisRapor", con);
        ...
        private void btnListele_Click(object sender, EventArgs e)
        {
            ...
            tablo.Clear();
            con.Open();
            SqlDataAdapter adtr = new SqlDataAdapter("SELECT raporKayitTarihi,raporToptanciAdi,raporUrunAdi,raporAlisFiyati,raporAdet,raporToplamFiyat  FROM ToptanciAlisverisRapor WHERE raporKayitTarihi=@gun", con);
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT SUM(raporToplamFiyat) FROM ToptanciAlisverisRapor WHERE raporKayitTarihi=@gun", con);
        ...
        private void btnListele1_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter adtr = new SqlDataAdapter("SELECT raporKayitTarihi,raporToptanciAdi,raporUrunAdi,raporAlisFiyati,raporAdet,raporToplamFiyat FROM ToptanciAlisverisRapor WHERE MONTH(raporKayitTarihi)=@ay AND YEAR(raporKayitTarihi)=@yil", con);
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT SUM(raporToplamFiyat) FROM ToptanciAlisverisRapor WHERE MONTH(raporKayitTarihi)=@ay AND YEAR(raporKayitTarihi)=@yil", con);
        ...
        private void btnListele2_Click(object sender, EventArgs e)
        {
            ...
            tablo.Clear();
            con.Open();
            SqlDataAdapter adtr = new SqlDataAdapter("SELECT raporKayitTarihi,raporToptanciAdi,raporUrunAdi,raporAlisFiyati,raporAdet,raporToplamFiyat FROM ToptanciAlisverisRapor WHERE raporKayitTarihi BETWEEN @tar1 AND @tar2", con);
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT SUM(raporToplamFiyat) FROM ToptanciAlisverisRapor WHERE raporKayitTarihi BETWEEN @tar1 AND @tar2", con);
        ...
        private void btnHepsi_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlDataAdapter adtr = new SqlDataAdapter("SELECT raporKayitTarihi,raporToptanciAdi,raporUrunAdi,raporAlisFiyati,raporAdet,raporToplamFiyat  FROM ToptanciAlisverisRapor", con);
            adtr.SelectCommand.Parameters.AddWithValue("@gun", Convert.ToDateTime(dateTimePicker1.Text));
            adtr.Fill(tablo);
            dataGridView1.DataSource = tablo;
            con.Close();
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT SUM(raporToplamFiyat) FROM ToptanciAlisverisRapor", con);
            cmd.Parameters.AddWithValue("@gun", Convert.ToDateTime(dateTimePicker1.Text));
            label2.Text = cmd.ExecuteScalar() + " TL";
            con.Close();
        }
        ...
        private void btnBul_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection(gnl.conString);
            tablo.Clear();
            da = new SqlDataAdapter("SELECT raporKayitTarihi,raporToptanciAdi,raporUrunAdi,raporAlisFiyati,raporAdet,raporToplamFiyat FROM ToptanciAlisverisRapor WHERE raporToptanciAdi LIKE '%" + textBox1.Text + "%'", con);
            da.Fill(tablo);
            dataGridView1.DataSource = tablo;
            con.Close();

            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT SUM(raporToplamFiyat) FROM ToptanciAlisverisRapor WHERE raporToptanciAdi LIKE '%" + textBox1.Text + "%'", con);
            label2.Text = cmd.ExecuteScalar() + " TL";
            con.Close();
            isimgetir();
        }

        private void frmToptanciRaporu_Load(object sender, EventArgs e)
        {
