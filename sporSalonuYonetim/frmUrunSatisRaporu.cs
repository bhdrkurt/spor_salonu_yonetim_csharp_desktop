...
namespace sporSalonuYonetim
{
    public partial class frmUrunSatisRaporu : Form
    {
        ...
        void isimgetir()
        {
            ...
            cmd.CommandText = "SELECT UrunSatis.urunSatisUyeninAdi FROM UrunSatis";
            cmd.ExecuteNonQuery();
        ...
        void raporlistele()
        {
            SqlConnection con = new SqlConnection(gnl.conString);
            con.Open();
            da = new SqlDataAdapter("SELECT urunSatisTarihi,urunSatisUyeninAdi,urunSatisUrunAdi,urunSatisFiyati FROM UrunSatis", con);
        ...
        private void btnListele_Click(object sender, EventArgs e)
        {
            ...
            tablo.Clear();
            con.Open();
            SqlDataAdapter adtr = new SqlDataAdapter("SELECT urunSatisTarihi,urunSatisUyeninAdi,urunSatisUrunAdi,urunSatisFiyati FROM UrunSatis WHERE urunSatisTarihi=@gun", con);
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT SUM(urunSatisFiyati) FROM UrunSatis WHERE urunSatisTarihi=@gun", con);
        ...
        private void btnListele1_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter adtr = new SqlDataAdapter("SELECT urunSatisTarihi,urunSatisUyeninAdi,urunSatisUrunAdi,urunSatisFiyati FROM UrunSatis WHERE MONTH(urunSatisTarihi)=@ay AND YEAR(urunSatisTarihi)=@yil", con);
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT SUM(urunSatisFiyati) FROM UrunSatis WHERE MONTH(urunSatisTarihi)=@ay AND YEAR(urunSatisTarihi)=@yil", con);
        ...
        private void btnListele2_Click(object sender, EventArgs e)
        {
            ...
            tablo.Clear();
            con.Open();
            SqlDataAdapter adtr = new SqlDataAdapter("SELECT urunSatisTarihi,urunSatisUyeninAdi,urunSatisUrunAdi,urunSatisFiyati FROM UrunSatis WHERE urunSatisTarihi BETWEEN @tar1 AND @tar2", con);
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT SUM(urunSatisFiyati) FROM UrunSatis WHERE urunSatisTarihi BETWEEN @tar1 AND @tar2", con);
        ...
        private void btnBul_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection(gnl.conString);
            tablo.Clear();
            da = new SqlDataAdapter("SELECT urunSatisTarihi,urunSatisUyeninAdi,urunSatisUrunAdi,urunSatisFiyati FROM UrunSatis WHERE urunSatisUyeninAdi LIKE '%" + textBox1.Text + "%'", con);
            da.Fill(tablo);
            dataGridView1.DataSource = tablo;
            con.Close();

            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT SUM(urunSatisFiyati) FROM UrunSatis WHERE urunSatisUyeninAdi LIKE '%" + textBox1.Text + "%'", con);
            label6.Text = cmd.ExecuteScalar() + " TL";
            con.Close();
            isimgetir();
        }
        ...
        private void btnHepsi_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlDataAdapter adtr = new SqlDataAdapter("SELECT urunSatisTarihi,urunSatisUyeninAdi,urunSatisUrunAdi,urunSatisFiyati FROM UrunSatis", con);
            adtr.Fill(tablo);
            dataGridView1.DataSource = tablo;
            con.Close();

            con.Open();
            SqlCommand cmd = new SqlCommand("SELECT SUM(urunSatisFiyati) FROM UrunSatis", con);
            cmd.Parameters.AddWithValue("@gun", Convert.ToDateTime(dateTimePicker1.Text));
            label6.Text = cmd.ExecuteScalar() + " TL";
            con.Close();
        }
