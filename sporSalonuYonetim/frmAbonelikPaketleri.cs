...
{
    public partial class frmAbonelikPaketleri : Form
    {
        SqlCommand cmd;
        public static GirisBilgi User { get; set; }
        public frmAbonelikPaketleri()
        {
            InitializeComponent();
           #region yetkiler
        ...
        private void egitmengetir()
        {
            ...
            {
                comboBox1.Items.Add(dr["personelAdi"].ToString());
            }
            con.Close();
        ...
        private void btnPaketKayit_Click(object sender, EventArgs e)
        {
            ...
            if (txtAbonePaketAdi.Text == "")
            {
                label8.Visible = true;
                label8.ForeColor = Color.Red;
                label8.Text = "Lütfen Paket Adını giriniz.";

            }
            else if (cmbAy.Text == "0")
            {
                label8.Visible = true;
                label8.ForeColor = Color.Red;
                label8.Text = "Lütfen süre kısmını doldurunuz.";
            }
            else if (txtFiyat.Text == "")
            {
                label8.Visible = true;
                label8.ForeColor = Color.Red;
                label8.Text = "Lütfen Fiyatını giriniz.";
            }


            if (txtAbonePaketAdi.Text != "" && cmbAy.Text != "0" && txtFiyat.Text != "")
            {
                try
                {
                    con.Open();
                    SqlCommand komut = new SqlCommand("INSERT INTO Paketler(paketAdi,fiyat,sure,egitmenadi) VALUES (@p1,@p2,@p3,@p4)", con);
                    komut.Parameters.AddWithValue("@p1", txtAbonePaketAdi.Text);
                    komut.Parameters.AddWithValue("@p2", txtFiyat.Text);
                    komut.Parameters.AddWithValue("@p3", cmbAy.Text);
                    komut.Parameters.AddWithValue("@p4", comboBox1.Text);
                    komut.ExecuteNonQuery();
                    con.Close();
                    label8.Visible = true;
                    label8.ForeColor = Color.Green;
                    label8.Text = "Kayıt Tamamlanmıştır.";
                    txtAbonePaketAdi.Text = "";
                    txtFiyat.Text = "";
                    cmbAy.Text = "0";
                    label9.Text = "";
            ...
            else
            {
                ...
                label9.Text = "Yazı Rengi Kırmızı Olan Yere Dikkat Ediniz.";
            }
        }
        ...
        private void frmAbonelikPaketleri_Load(object sender, EventArgs e)
        {
            egitmengetir();
